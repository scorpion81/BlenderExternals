...
ExternalProject_Add(external_opencollada
  ...
  PATCH_COMMAND dos2unix ${PATCH_DIR}/opencollada.diff && dos2unix ${BUILD_DIR}/opencollada/src/external_opencollada/CMakeLists.txt &&  ${PATCH_CMD} -p 1 -N -l -d  ${BUILD_DIR}/opencollada/src/external_opencollada < ${PATCH_DIR}/opencollada.diff
