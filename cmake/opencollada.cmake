...
ExternalProject_Add(external_opencollada
  ...
  PATCH_COMMAND unix2dos ${PATCH_DIR}/opencollada.diff &&  ${PATCH_CMD} -p 1 -N -l -d --binary ${BUILD_DIR}/opencollada/src/external_opencollada < ${PATCH_DIR}/opencollada.diff
